...
const CreateLaboratoriumDialog = ({ open, onClose }: any) => {
  ...
  return (
    <Dialog fullWidth open={open} maxWidth='md' scroll='body' TransitionComponent={Transition}>
      <DialogTitle sx={{ mb: 6, px: { xs: 8, sm: 15 }, position: 'relative', backgroundColor: '#F7F7F9' }}>
        ...
        <Box>
          <Typography variant='h5'>Tambah Ruangan Laboratorium</Typography>
          <Typography>Isi formulir berikut untuk detail Ruangan Laboratorium baru</Typography>
        </Box>
      </DialogTitle>
...
export default CreateLaboratoriumDialog
