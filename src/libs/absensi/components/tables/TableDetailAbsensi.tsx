...
export default function DetailAbsensiTable() {
  ...
  const columns = [
    ...
    },
    {
      ...
      sortable: false,
      renderCell: () => {
        return <Chip label='Hadir' color='success' />
      }
    },
    {
      flex: 0.25,
      ...
      sortable: false,
      renderCell: () => {
        return <Chip label='Tidak Hadir' color='error' />
      }
    },
    {
      flex: 0.25,
    ...
    },
    {
      flex: 0.25,
      field: 'total',
      headerName: 'Total Kehadiran',
      minWidth: 160,
      sortable: false,
      renderCell: (params: any) => {
        return <span>{params?.row?.total ?? '-'}</span>
      }
    },
    {
      flex: 0.25,
      ...
      sortable: false,
      renderCell: (params: any) => {
        return <span>{params?.row?.percentage ?? '-'}</span>
      }
    }
  ]
